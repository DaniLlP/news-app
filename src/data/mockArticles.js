...
export const mockArticles = [
  ...
  // ============================================================
  {
    ...
    comments: 312,
    title: m(
      "Barcelona presenta su nuevo plan de movilidad urbana 2026-2028 con 150Mâ‚¬ de inversión",
      "Barcelona unveils its new 2026-2028 urban mobility plan with â‚¬150M investment",
      "Barcelona presenta el seu nou pla de mobilitat urbana 2026-2028 amb 150Mâ‚¬ d\u2019inversió",
    ),
    summary: m(
    ...
    sourceUrl: "https://www.lavanguardia.com",
      ...
      opinion: m(
        ...
        "La nostra posició és clara: Barcelona no es pot permetre un altre pla de mobilitat que mori als despatxos. L\u2019evidència de les superilles és contundent â€”menys soroll, menys NO2, més comerç de proximitatâ€” i el cost de no actuar es paga en salut. L\u2019Ajuntament ha de blindar el calendari davant dels cicles electorals, i l\u2019oposició faria bé de negociar millores en lloc de bloquejar. Ã‰s la inversió amb millor relació cost-benefici de la ciutat.",
      ),
    },
  },
  {
  ...
  },
  {
    ...
    content: m(
      ...
      "Incasòl data confirms the average rent now stands at â‚¬1,087 per month. The drop is steepest in Ciutat Vella and Gràcia, the most stressed areas. Landlord associations claim part of the housing stock has shifted to seasonal lets, an effect the Catalan government promises to regulate this quarter.",
  ...
  },
  {
    ...
    content: m(
      ...
      "The season closes with 92% occupancy on the Costa Brava and record visitors in the Pyrenees. The industry celebrates while the overcrowding debate grows: Sitges and Cadaqués are studying tourist-flat caps. Total spending exceeds â‚¬14 billion.",
    ...
    insight: {
      ...
      perspectives: [
        ...
        },
        {
          ...
          tone: "critical",
          text: m(
            "El puerto arriesga 200Mâ‚¬ anuales y liderazgo mediterráneo.",
  ...
  },
  {
    ...
    comments: 245,
    title: m(
      "Las startups españolas captan 2.400Mâ‚¬ y baten su récord de inversión anual",
      "Spanish startups raise â‚¬2.4bn, smashing their annual investment record",
      "Les startups espanyoles capten 2.400Mâ‚¬ i baten el seu rècord d\u2019inversió anual",
    ),
    summary: m(
    ...
    insight: {
      ...
      opinion: m(
        ...
        "El rècord és real i celebrable, però l\u2019ecosistema espanyol segueix jugant amb una mà lligada: el capital institucional nacional â€”pensions, asseguradoresâ€” amb prou feines toca el venture capital mentre a França o Suècia n\u2019és la columna vertebral. Demanar al talent que es quedi mentre l\u2019estalvi del país se\u2019n va a totxo i deute és incoherent. La propera reforma s\u2019escriu sola: incentius fiscals seriosos perquè l\u2019estalvi institucional financiï l\u2019economia del coneixement. La resta és aplaudir amb una mà.",
      ),
    },
  },
  {
  ...
  },
  {
    ...
    summary: m(
      "La línea ibérica arranca con 8 frecuencias diarias y billetes desde 39â‚¬. Aviación prevé perder el 60% del tráfico aéreo entre ambas ciudades.",
      ...
      "La línia ibèrica arrenca amb 8 freqüències diàries i bitllets des de 39â‚¬. L\u2019aviació preveu perdre el 60% del trànsit aeri entre ambdues ciutats.",
    ),
    content: m(
      "El proyecto, financiado en un 40% con fondos europeos, culmina dos décadas de negociaciones intermitentes. El tramo Badajoz-Ã‰vora ha sido el último en completarse. Los operadores estudian ya extender frecuencias a Oporto y conectar con la red francesa para un corredor Lisboa-París.",
      ...
      "El projecte, finançat en un 40% amb fons europeus, culmina dues dècades de negociacions intermitents. El tram Badajoz-Ã‰vora ha estat l\u2019últim a completar-se. Els operadors ja estudien estendre freqüències a Porto i connectar amb la xarxa francesa per a un corredor Lisboa-París.",
    ),
    insight: {
      stance: "supportive",
      synthesis: m(
  ...
  },
  {
    ...
    content: m(
      ...
      "Ã‰s el tercer gran premi europeu per a una producció espanyola en dos anys. Les plataformes ja es disputen els drets globals de distribució. La indústria reivindica el model de coproducció iberoamericana i els incentius fiscals que han multiplicat els rodatges internacionals a Espanya.",
    ),
    insight: {
      stance: "supportive",
      synthesis: m(
  ...
  },
  {
    ...
    summary: m(
      "El perfil medio: 34 años, ingresos de 4.200â‚¬ mensuales y estancia de 18 meses. Málaga, Valencia y Las Palmas concentran la mitad.",
      "The average profile: 34 years old, â‚¬4,200 monthly income, 18-month stays. Málaga, Valencia and Las Palmas host half of them.",
      "El perfil mitjà: 34 anys, ingressos de 4.200â‚¬ mensuals i estada de 18 mesos. Màlaga, València i Las Palmas en concentren la meitat.",
    ),
    content: m(
    ...
    insight: {
      stance: "critical",
      synthesis: m(
        "La prensa internacional lo presenta como éxito de atracción de talento; la local documenta el reverso: cafés a 6â‚¬ y alquileres imposibles en los barrios nómadas.",
        ...
        "La premsa internacional ho presenta com un èxit d\u2019atracció de talent; la local en documenta el revers: cafès a 6â‚¬ i lloguers impossibles als barris nòmades.",
      ),
      perspectives: [
        {
          source: "Forbes",
  ...
  },
  {
    ...
    insight: {
      ...
      opinion: m(
        ...
        'La humanitat acaba de fer una cosa inusual: regular una tecnologia abans de la catàstrofe, no després. Aquest mèrit és enorme i convé defensar-lo davant del lobby del "no es pot aturar el progrés" â€”el mateix argument que va retardar dècades l\u2019acció sobre el tabac o el clima. Ã‰s imperfecte? Ã‰s clar: sense armes autònomes dins, el tractat neix coix. Però els marcs s\u2019amplien; els buits es paguen. La transparència sobre dades i les auditories no frenen la innovació: frenen la impunitat. I distingir totes dues coses és exactament el que defineix una societat madura.',
      ),
    },
  },
  {
    ...
    sourceUrl: "https://www.bbc.com/news",
      ...
      opinion: m(
        ...
        "La nostra opinió no admet tebiesa: finançar l\u2019adaptació mentre s\u2019esquiva el calendari de sortida dels fòssils és pagar l\u2019enterrament negant-se a trucar al metge. El fons de 300.000 milions és necessari i arriba tard i curt â€”la factura real de l\u2019adaptació s\u2019estima en el tripleâ€”. Però l\u2019escàndol de fons és un altre: 80 països van demanar data de caducitat per al petroli i la minoria bloquejadora va guanyar un altre cop. Mentre el veto dels petroestats segueixi operant per consens, aquestes cimeres seguiran produint comunicats en lloc de futur. Cal reformar les regles del joc: majories qualificades i sancions comercials verdes. La resta és teatre amb jet lag.",
      ),
    },
  },
  {
  ...
  },
  {
    ...
    summary: m(
      ...
      "L\u2019assaig de fase 3 amb 4.200 pacients mostra la major eficàcia registrada. El preu anunciat, 28.000â‚¬ anuals, obre el debat de l\u2019accés.",
    ),
    content: m(
    ...
    sourceUrl: "https://www.nature.com",
      ...
      opinion: m(
        ...
        "Ã‰s l\u2019avenç mèdic més esperançador de la dècada i alhora un mirall incòmode per als nostres sistemes de salut. Un fàrmac que només funciona en fases primerenques és inútil en països on el diagnòstic arriba, de mitjana, tres anys tard: sense una revolució paral·lela del cribratge â€”biomarcadors en sang, memòria a l\u2019atenció primàriaâ€” comprarem esperança cara per a uns pocs. I sobre el preu, claredat: la recerca es va finançar en part amb diners públics, i els estats tenen el deure i la palanca de negociar en bloc. Celebrar la ciència i lluitar per l\u2019accés no són postures oposades; són la mateixa obligació moral.",
      ),
    },
  },
  {
    ...
    insight: {
      stance: "supportive",
      synthesis: m(
        "La prensa deportiva europea coincide en la lectura romántica â€”gana la gestión, no el petrodólarâ€” aunque los analistas recuerdan que la excepción no derogará la regla del dinero.",
        ...
        "La premsa esportiva europea coincideix en la lectura romàntica â€”guanya la gestió, no el petrodòlarâ€” tot i que els analistes recorden que l\u2019excepció no derogarà la regla dels diners.",
      ),
      perspectives: [
        {
          source: "ESPN",
  ...
  },
  {
    ...
    sourceUrl: "https://www.bbc.com/news",
      ...
      opinion: m(
        'En una época de horizontes cortos y cinismo barato, esta misión es un recordatorio de lo que las instituciones humanas pueden lograr cuando piensan en décadas: tres agencias, veinte años, siete mil millones de kilómetros y ni un solo fallo crítico. Quienes reducen la exploración espacial a un lujo ignoran su dividendo real â€”tecnología, talento, y la disciplina de lo difícilâ€”. Y una advertencia contra el hype: si dentro de dos años los laboratorios anuncian "resultados ambiguos", eso no será un fracaso sino ciencia funcionando. La paciencia que trajo estas rocas a casa es la misma que exigirá leerlas.',
